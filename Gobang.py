...
QUIT_FLAG = False
###
win = GraphWin("五子棋", 560, 471)
win.info
aiFirst = Text(Point(510, 110), "")
manFirst = Text(Point(510, 150), "")
notice = Text(Point(510, 300), "")  # 提示轮到谁落子
notice.setFill('red')
last_ai = Text(Point(510, 340), "")  # AI最后落子点
last_man = Text(Point(510, 380), "")  # 玩家最后落子点
QUIT = Text(Point(510, 30), "退出")
QUIT.setFill('red')
RESTART = Text(Point(510, 70), "重玩")
RESTART.setFill('red')
num0 = Text(Point(10, 10), "1")
num1 = Text(Point(10, 40), "2")
num2 = Text(Point(10, 70), "3")
num3 = Text(Point(10, 100), "4")
num4 = Text(Point(10, 130), "5")
num5 = Text(Point(10, 160), "6")
num6 = Text(Point(10, 190), "7")
num7 = Text(Point(10, 220), "8")
num8 = Text(Point(10, 250), "9")
num9 = Text(Point(10, 280), "10")
num10 = Text(Point(10, 310), "11")
num11 = Text(Point(10, 340), "12")
num12 = Text(Point(10, 370), "13")
num13 = Text(Point(10, 400), "14")
num14 = Text(Point(10, 430), "15")
num15 = Text(Point(10, 460), "16")
numm1 = Text(Point(40, 10), "2")
numm2 = Text(Point(70, 10), "3")
numm3 = Text(Point(100, 10), "4")
numm4 = Text(Point(130, 10), "5")
numm5 = Text(Point(160, 10), "6")
numm6 = Text(Point(190, 10), "7")
numm7 = Text(Point(220, 10), "8")
numm8 = Text(Point(250, 10), "9")
numm9 = Text(Point(280, 10), "10")
numm10 = Text(Point(310, 10), "11")
numm11 = Text(Point(340, 10), "12")
numm12 = Text(Point(370, 10), "13")
numm13 = Text(Point(400, 10), "14")
numm14 = Text(Point(430, 10), "15")
numm15 = Text(Point(460, 10), "16")
...
def drawWin():
    ...
    for i in range(10, 461, 30):
        line = Line(Point(i, 10), Point(i, 460))
        line.draw(win)
    for j in range(10, 461, 30):
        line = Line(Point(10, j), Point(460, j))
        line.draw(win)
    Rectangle(Point(470, 15), Point(550, 45)).draw(win)
    Rectangle(Point(470, 55), Point(550, 85)).draw(win)
    Rectangle(Point(470, 95), Point(550, 125)).draw(win)
    Rectangle(Point(470, 135), Point(550, 165)).draw(win)
    Rectangle(Point(462, 285), Point(558, 315)).draw(win)
    Rectangle(Point(462, 317), Point(558, 405)).draw(win)
    aiFirst.draw(win)
    manFirst.draw(win)
    notice.draw(win)
    last_ai.draw(win)
...
def manPlay():
    ...
    print("输入下棋点横坐标")
    Psc()
    recv = sendmess("输入下棋点横坐标")
    order1 =int(recv)
    print("输入下棋点纵坐标")
    Psc()
    recv = sendmess("输入下棋点纵坐标")
    order2 = int(recv)
    # if (order == 'quit'):
    #     p = Point(500, 20)
    # elif (order == 'restart'):
...
def go(x, y):
    global is_end
    c = Circle(Point(x * 30+10, y * 30+10), 13)
    if (start == ai):
        num[x][y] = ai
    ...
    if (ban(x, y)):
        if (start == ai):
            notice.setText("AI 禁手,玩家获胜!\n点击重玩")
            print("AI禁手,玩家获胜!")
            Psc()
            recv = sendmess("AI禁手,玩家获胜")
        else:
            notice.setText("玩家禁手,AI获胜!\n点击重玩")
            print("玩家禁手,AI获胜!")
            Psc()
            recv = sendmess("玩家禁手,AI获胜!")
        is_end = True
    elif (gameOver(x, y)):
        if (start == ai):
            notice.setText("AI获胜!\n点击重玩")
...
def Gobang():
    ...
    Psc()
    print("输入quit 退出游戏 输入restart 重玩游戏 \n选择先手顺序 输入black 玩家先手 输入white AI先手")
    recv = sendmess("输入quit 退出游戏 输入restart 重玩游戏 \n选择先手顺序 输入black 玩家先手 输入white AI先手")
    # p = win.getMouse()
    order = recv
    if (order == 'quit'):
        p = Point(500, 20)
    ...
    while (not is_end):
        ...
        if (RESTART_FLAG):
            ...
            if (RESTART_FLAG):
                notice.setText("请选择先手")
                print("选择先手顺序 输入black 玩家先手 输入white AI先手")
                Psc()
                recv = sendmess("选择先手顺序 输入black 玩家先手 输入white AI先手")
                # p = win.getMouse()
                order = recv
                if (order == 'black'):
                    p = Point(500, 140)
